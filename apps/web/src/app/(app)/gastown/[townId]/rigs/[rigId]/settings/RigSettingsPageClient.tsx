...
export function RigSettingsPageClient({ townId, rigId }: Props) {
  ...
  function populateStateFromConfig() {
    ...
    setInherited({
      ...
      require_clean_merge: rigConfig.refinery?.require_clean_merge == null,
      code_review: rigConfig.refinery?.code_review == null,
      custom_instructions: !rigConfig.custom_instructions,
      git_push_flags: !rigConfig.git_push_flags?.length,
      default_branch: !rigConfig.default_branch,
      max_polecats_per_rig: !rigConfig.max_polecats_per_rig,
      staged_convoys_default: rigConfig.staged_convoys_default == null,
      default_convoy_merge_mode: !rigConfig.default_convoy_merge_mode,
    });
  }
